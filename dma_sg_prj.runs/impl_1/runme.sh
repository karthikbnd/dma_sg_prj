...
HD_PWD='C:/Users/kab/Desktop/workspace/dma_sg_prj/dma_sg_prj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dma_sg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_dma_sg_wrapper.tcl -notrace
