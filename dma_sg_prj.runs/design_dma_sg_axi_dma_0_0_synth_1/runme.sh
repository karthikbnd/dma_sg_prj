...
HD_PWD='C:/Users/kab/Desktop/workspace/dma_sg_prj/dma_sg_prj.runs/design_dma_sg_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dma_sg_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_dma_sg_axi_dma_0_0.tcl
